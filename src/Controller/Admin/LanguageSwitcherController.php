...
class LanguageSwitcherController extends AbstractController
{
    ...
    public function switch(string $locale, Request $request): JsonResponse|Response
    {
        try {
            ...
            if (!$language) {
                $message = $this->translator->trans('language_switch.invalid_or_inactive', ['%locale%' => $locale]);
            ...
            $message = $this->translator->trans('language_switch.error_switching', ['%error%' => $e->getMessage()]);
